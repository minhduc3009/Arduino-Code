...
class DMD
{
  ...
  //Draw a string
  void drawString( int bX, int bY,unsigned char* bChars, byte length, byte bGraphicsMode);

  //Select a text font
  void selectFont(const uint16_t* font);

  //Draw a single character
  int drawChar(const int bX, const int bY,unsigned char letter, byte bGraphicsMode);

  //Find the width of a character
  int charWidth( unsigned char letter);

  //Draw a scrolling string
  void drawMarquee( unsigned char* bChars, byte length, int left, int top);
